...
public class UserWatchedEntertainWorkApiTest{
    ...
    public UserWatchedEntertainWorkApiTest(){
    }
    ...
    void setUp(){
        ...
        RestAssured.basePath = "/users/{userId}/watch";
    ...
    @Test
    void when_PuttingEntertainWorkForUserWithoutEnoughCredits_Expect_Status400TitleAndDetail(){
        savedUser.getCredit().setQuantity(0);
        ...
        RestAssured
                ...
                .then()
                .statusCode(BAD_REQUEST.value())
                .body("title", equalTo(BUSSINESS_ERROR_TYPE_TITLE))
                .body("detail", equalTo(getCreditsMissingErrorDetail()));
    }
    ...
    private void setUpData(){
        ...
        savedUser.addWatchedEntertainWorks(entertainmentWorkRepository.findById(1L).orElseThrow());

        userRepository.save(savedUser);

        entertainWorkQuantity = savedUser.getWatchedEntertainWorks().size();
    }
    ...
    private String getCreditsMissingErrorDetail(){
        return "User doesn't have enough credits available";
    }
}
